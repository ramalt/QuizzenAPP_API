...
public class CreateQuestionVoteCommandHandler : IRequestHandler<CreateQuestionVoteCommand, bool>
{
    public async Task<bool> Handle(CreateQuestionVoteCommand request, CancellationToken cancellationToken)
    {
